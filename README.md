...
> 你的文字，也可以自己好好收著。備份是一種好習慣，創作者本來就該握有自己的副本。
...
如果你想多留一份在線上，可以把兩個檔案上傳到自己的分散式空間 Pinata：
...
> 請用 Matters 記憶吐司幫我備份 matters 用戶名 XXX。先下載完整備份；如果我要線上保存，再引導我用 Pinata；如果我要架站，再產出 Cloudflare 可上傳的部落格網站包。
